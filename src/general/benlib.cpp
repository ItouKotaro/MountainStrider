...
bool Benlib::IsObjectInFrustum(const D3DXMATRIX& matProj, const D3DXMATRIX& matView, const D3DXVECTOR3& center, const float& radius)
{
	...
	// 視錐台の平面を抽出
	D3DXPLANE planes[6];
	planes[0] = D3DXPLANE(matViewProjInv._14 + matViewProjInv._11, matViewProjInv._24 + matViewProjInv._21, matViewProjInv._34 + matViewProjInv._31, matViewProjInv._44 + matViewProjInv._41); // 左
	planes[1] = D3DXPLANE(matViewProjInv._14 - matViewProjInv._11, matViewProjInv._24 - matViewProjInv._21, matViewProjInv._34 - matViewProjInv._31, matViewProjInv._44 - matViewProjInv._41); // 右
	planes[2] = D3DXPLANE(matViewProjInv._14 - matViewProjInv._12, matViewProjInv._24 - matViewProjInv._22, matViewProjInv._34 - matViewProjInv._32, matViewProjInv._44 - matViewProjInv._42); // 上
	planes[3] = D3DXPLANE(matViewProjInv._14 + matViewProjInv._12, matViewProjInv._24 + matViewProjInv._22, matViewProjInv._34 + matViewProjInv._32, matViewProjInv._44 + matViewProjInv._42); // 下
	planes[4] = D3DXPLANE(matViewProjInv._13, matViewProjInv._23, matViewProjInv._33, matViewProjInv._43); // 近
	planes[5] = D3DXPLANE(matViewProjInv._14 - matViewProjInv._13, matViewProjInv._24 - matViewProjInv._23, matViewProjInv._34 - matViewProjInv._33, matViewProjInv._44 - matViewProjInv._43); // 遠
